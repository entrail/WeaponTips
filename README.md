...
**and** TBC Classic (Anniversary). Every weapon tooltip gets one clear,
...
- **Shamans** looking at a two-handed axe or mace are told it requires
  ...
  those, and no addon should send you on that trip.
...
- Class rules match the era: no rogue axes, no druid polearms — those
  came years later, and WeaponTips won't send you to a trainer who can't
  help you.
...
- The addon's own lines are translated for **German, French, Spanish
  (EU and Latin America) and Brazilian Portuguese**; other locales see
